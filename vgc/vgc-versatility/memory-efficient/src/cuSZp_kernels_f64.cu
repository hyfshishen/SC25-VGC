...
__global__ void cuSZp_compress_kernel_plain_f64_profiling(const double* const __restrict__ oriData, 
                                                        volatile unsigned int* const __restrict__ cmpOffset, 
                                                        volatile unsigned int* const __restrict__ locOffset, 
                                                        volatile int* const __restrict__ flag, 
                                                        const double eb, const size_t nbEle)
...
__global__ void cuSZp_compress_kernel_plain_f64_concatenate(const double* const __restrict__ oriData, 
                                                            unsigned char* const __restrict__ cmpData, 
                                                            volatile unsigned int* const __restrict__ cmpOffset, 
                                                            volatile unsigned int* const __restrict__ locOffset, 
                                                            volatile int* const __restrict__ flag, 
                                                            const double eb, const size_t nbEle)
{
    ...
    if(!lane) {
        if(warp==0) base_idx = rate_ofs;
        else base_idx = cmpOffset[warp] + rate_ofs;
    }
    __syncthreads();
