...
int main(int argc, char *argv[])
{
    ...
    for(int i=0; i<3; i++) {
        ...
        cuSZp_compress_2D_outlier_f64(d_oriData, d_cmpBytes, nbEle, &cmpSize, dims, errorBound, stream);
    }
    ...
    cuSZp_decompress_2D_outlier_f64(d_decData, d_cmpBytes, nbEle, cmpSize, dims, errorBound, stream);
